    ...
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-8 text-center">
          <div className="p-8 bg-blue-50 rounded-xl shadow-md hover:shadow-lg transition">
            <h3 className="text-4xl font-bold text-[#1e3a5f]">10,000+</h3>
            <p className="text-gray-600 mt-2">Internships Listed</p>
          </div>
          <div className="p-8 bg-green-50 rounded-xl shadow-md hover:shadow-lg transition">
            <h3 className="text-4xl font-bold text-[#1e3a5f]">5,000+</h3>
          ...
          <div className="p-8 bg-purple-50 rounded-xl shadow-md hover:shadow-lg transition">
            <h3 className="text-4xl font-bold text-[#1e3a5f]">50,000+</h3>
            <p className="text-gray-600 mt-2">Students Empowered</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition">
              <img
                ...
                className="w-24 h-24 mx-auto rounded-full object-cover mb-6"
              />
              <h3 className="text-xl font-semibold text-gray-900">Sophia Lee</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition">
              <img
                ...
                className="w-24 h-24 mx-auto rounded-full object-cover mb-6"
              />
              <h3 className="text-xl font-semibold text-gray-900">Michael Smith</h3>
      ...
      <section className="py-20 bg-[#1e3a5f] text-white text-center">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/find-internships"
              className="bg-white text-[#1e3a5f] px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition"
            >
              Find Internships
            </Link>
            <Link
              to="/post-internship"
              className="border-2 border-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-[#1e3a5f] transition"
            >
              Partner With Us
            </Link>
          </div>
