  ...
  const renderFields = () => {
    switch (step) {
      case 0:
        return (
          <>
            ...
            <Input label="Company Name" placeholder="Acme Corp" icon={<Building />} />
      ...
      case 1:
        return (
          <>
            <Input label="Work Email" type="email" placeholder="john@acme.com" />
    ...
    <main className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800">Register as an Employer</h1>
          <p className="text-gray-600 mt-2">Create your account in a few simple steps</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6 sm:p-8">
          ...
          <div className="flex gap-3 mt-8">
            ...
            {step < totalSteps - 1 ? (
              ...
              <button className="flex-1 py-2.5 rounded-lg bg-green-600 text-white hover:bg-green-700">
                Create Account
              </button>
            )}
          </div>
...
const Select = ({ label, children }) => (
  <label className="block">
    <span className="text-sm font-medium text-gray-700">{label}</span>
    <select className="mt-1 w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 py-2 px-3">
      {children}
    </select>
  </label>
);
