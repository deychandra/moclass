...
const Home = () => {
  return (
    <>
      {/* Hero Section */}
      <section
        className="bg-gradient-to-br to-blue-50 py-10 min-h-screen flex items-center"
        style={{
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:justify-center lg:justify-start">
                <Link
                  to="/find-internships"
                  className="bg-[#1e3a5f] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold hover:bg-[#1e3a5f] hover:text-white transition-all transform hover:scale-105 w-full sm:w-auto text-center"
                >
                  Find Internships
                </Link>
                <Link
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 transition-transform duration-300">
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-100 rounded-full flex items-center justify-center">
                      <svg
                        ...
                        viewBox="0 0 20 20"
                      >
                        <path d="M13 6a3 3 0 11-6 
                        0 3 3 0 016 0zM18 8a2 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-blue-100 rounded-full flex items-center justify-center mb-6">
                <svg
            ...
            {/* Card 2 */}
            <div className="bg-white p-6 sm:p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-green-100 rounded-full flex items-center justify-center mb-6">
                <svg
            ...
            {/* Card 3 */}
            <div className="bg-white p-6 sm:p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-purple-100 rounded-full flex items-center justify-center mb-6">
                <svg
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {/* Category Cards */}
            <div className="bg-gradient-to-br from-blue-500 to-blue-600 p-6 rounded-xl text-white hover:scale-105 transition-transform cursor-pointer">
              <h3 className="text-lg font-semibold mb-2">Technology</h3>
              <p className="text-blue-100 text-sm mb-3">
                Software Development, AI/ML, Data Science
              </p>
              <p className="text-xl sm:text-2xl font-bold">2,500+ jobs</p>
            </div>
            <div className="bg-gradient-to-br from-green-500 to-green-600 p-6 rounded-xl text-white hover:scale-105 transition-transform cursor-pointer">
              <h3 className="text-lg font-semibold mb-2">Marketing</h3>
              <p className="text-green-100 text-sm mb-3">
                Digital Marketing, Content, Social Media
              </p>
              <p className="text-xl sm:text-2xl font-bold">1,800+ jobs</p>
            </div>
            <div className="bg-gradient-to-br from-purple-500 to-purple-600 p-6 rounded-xl text-white hover:scale-105 transition-transform cursor-pointer">
              <h3 className="text-lg font-semibold mb-2">Design</h3>
              <p className="text-purple-100 text-sm mb-3">
                UI/UX, Graphic Design, Product Design
              </p>
              <p className="text-xl sm:text-2xl font-bold">1,200+ jobs</p>
            </div>
            <div className="bg-gradient-to-br from-orange-500 to-orange-600 p-6 rounded-xl text-white hover:scale-105 transition-transform cursor-pointer">
              <h3 className="text-lg font-semibold mb-2">Finance</h3>
              <p className="text-orange-100 text-sm mb-3">
                Investment Banking, Fintech, Consulting
              </p>
              <p className="text-xl sm:text-2xl font-bold">900+ jobs</p>
            </div>
          </div>
        </div>
      </section>
